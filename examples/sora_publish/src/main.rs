            ...
            nojson::object(|f| {
                ...
                f.member(
                    ...
                    nojson::object(|f| {
                        ...
                        f.member("inputName", "sora-publish-input")?;
                        ...
                        f.member(
                            ...
                            nojson::object(|f| {
                                f.member(
                                    "soraSdkSettings",
                                    nojson::object(|f| {
                                        f.member("signalingUrls", [signaling_url])?;
    ...
    let msg = nojson::object(|f| {
        ...
        f.member(
            ...
            nojson::object(|f| {
                ...
                f.member(
                    "requestData",
                    nojson::object(|f| f.member("outputName", "sora")),
                )
            }),
        )
    })
...
fn main() -> noargs::Result<()> {
    ...
    args.metadata_mut().app_name = "sora_publish";
...
async fn run(
    ...
    tracing::info!("CreateInput 送信: {input_mp4_path}");

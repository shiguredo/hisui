...
// Sora の録画ファイル合成処理固有
#[cfg(feature = "nvcodec")]
use crate::sora_decoder_nvcodec_params;
        ...
        for (key, value) in value.to_object()? {
            match &*key.to_unquoted_string_str()? {
                ...
                "nvcodec_h264_decode_params" => {
                    params.nvcodec_h264 =
                        sora_decoder_nvcodec_params::parse_h264_decode_params(value)?;
                }
                #[cfg(feature = "nvcodec")]
                "nvcodec_h265_decode_params" => {
                    params.nvcodec_h265 =
                        sora_decoder_nvcodec_params::parse_h265_decode_params(value)?;
                }
                #[cfg(feature = "nvcodec")]
                "nvcodec_av1_decode_params" => {
                    params.nvcodec_av1 =
                        sora_decoder_nvcodec_params::parse_av1_decode_params(value)?;
                }
                #[cfg(feature = "nvcodec")]
                "nvcodec_vp8_decode_params" => {
                    params.nvcodec_vp8 =
                        sora_decoder_nvcodec_params::parse_vp8_decode_params(value)?;
                }
                #[cfg(feature = "nvcodec")]
                "nvcodec_vp9_decode_params" => {
                    params.nvcodec_vp9 =
                        sora_decoder_nvcodec_params::parse_vp9_decode_params(value)?;
                }
                _ => {}
            }
        }
...
impl LayoutDecodeParams {
    fn new_from_default_layout() -> Result<Self, nojson::JsonParseError> {
        ...
        #[cfg(feature = "nvcodec")]
        let nvcodec_h264 = sora_decoder_nvcodec_params::parse_h264_decode_params(
            value.to_member("nvcodec_h264_decode_params")?.required()?,
        )?;

        #[cfg(feature = "nvcodec")]
        let nvcodec_h265 = sora_decoder_nvcodec_params::parse_h265_decode_params(
            value.to_member("nvcodec_h265_decode_params")?.required()?,
        )?;

        #[cfg(feature = "nvcodec")]
        let nvcodec_av1 = sora_decoder_nvcodec_params::parse_av1_decode_params(
            value.to_member("nvcodec_av1_decode_params")?.required()?,
        )?;

        #[cfg(feature = "nvcodec")]
        let nvcodec_vp8 = sora_decoder_nvcodec_params::parse_vp8_decode_params(
            value.to_member("nvcodec_vp8_decode_params")?.required()?,
        )?;

        #[cfg(feature = "nvcodec")]
        let nvcodec_vp9 = sora_decoder_nvcodec_params::parse_vp9_decode_params(

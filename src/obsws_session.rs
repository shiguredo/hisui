...
impl ObswsSession {
    ...
    async fn handle_create_scene_item_request(
        &self,
        request_id: &str,
        request_data: Option<&nojson::RawJsonOwned>,
    ) -> SessionAction {
    ...
    async fn handle_remove_scene_item_request(
        &self,
        request_id: &str,
        request_data: Option<&nojson::RawJsonOwned>,
    ) -> SessionAction {
    ...
    async fn handle_duplicate_scene_item_request(
        &self,
        request_id: &str,
        request_data: Option<&nojson::RawJsonOwned>,
    ) -> SessionAction {
    ...
    async fn handle_set_scene_item_index_request(
        &self,
        request_id: &str,
        request_data: Option<&nojson::RawJsonOwned>,
    ) -> SessionAction {
    ...
    async fn handle_set_scene_item_locked_request(
        &self,
        request_id: &str,
        request_data: Option<&nojson::RawJsonOwned>,
    ) -> SessionAction {
    ...
    async fn handle_set_scene_item_blend_mode_request(
        &self,
        request_id: &str,
        request_data: Option<&nojson::RawJsonOwned>,
    ) -> SessionAction {
    ...
    async fn handle_set_scene_item_transform_request(
        &self,
        request_id: &str,
        request_data: Option<&nojson::RawJsonOwned>,
    ) -> SessionAction {
...
mod tests {
    ...
    async fn remove_scene_item_with_scene_subscription_sends_removed_and_reindexed_events() {
        ...
        let (_, second_event_type, second_event_intent) =
            parse_event_type_and_intent(&messages[2].0);

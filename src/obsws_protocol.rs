...
pub(crate) const OBSWS_DEFAULT_SCENE_NAME: &str = "Scene";
...
pub(crate) const REQUEST_STATUS_RESOURCE_NOT_FOUND: i64 = 601;
pub(crate) const REQUEST_STATUS_RESOURCE_ALREADY_EXISTS: i64 = 602;
